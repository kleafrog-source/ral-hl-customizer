...
function initLeaveHomeModal() {
    const trigger = document.getElementById('customizer-home-logo');
    ...
    const confirmBtn = modal.querySelector('[data-leave-confirm]');
    const closeButtons = modal.querySelectorAll('[data-leave-close]');
    const destinationUrl = trigger.dataset.homeUrl || '/';
