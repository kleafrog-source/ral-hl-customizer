    ...
    <div class="start-screen-faq-section">
      ...
      <div class="start-screen-faq-item animate-on-scroll" onclick="toggleFaq(this)">
        ...
        <div class="start-screen-faq-answer">
          ...
          <p>Для этого потребуется предоставить векторный файл изображения (SVG формат) или растровый файл (PNG, JPG, BMP, WEBP, ICO). Эта опция доступна за дополнительную плату.</p>
        </div>
      </div>
