...
class MicrophoneCustomizerComponent extends CBitrixComponent
{
    ...
    public function executeComponent()
    {
        try {
            ...
            // Р•СЃР»Рё ELEMENT_ID РЅРµ РїРµСЂРµРґР°РЅ РёР»Рё СЂР°РІРµРЅ 0, РёРЅРёС†РёР°Р»РёР·РёСЂСѓРµРј Р·РЅР°С‡РµРЅРёСЏ РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ
            if ($this->arParams["ELEMENT_ID"] > 0) {
                $this->arResult["ELEMENT"] = $this->getElement($this->arParams["ELEMENT_ID"]);
            } else {
                // Р—РЅР°С‡РµРЅРёСЏ РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ РґР»СЏ Р°РІС‚РѕРЅРѕРјРЅРѕР№ СЂР°Р±РѕС‚С‹
