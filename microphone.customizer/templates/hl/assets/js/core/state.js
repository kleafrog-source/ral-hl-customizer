...
// Assume a global or config-driven debug flag
const APP_DEBUG = false;

// Export debug flag for other modules
export { APP_DEBUG }; 
...
class StateManager {
    ...
    constructor() {
        ...
        this.#state = {
            currentModelCode: data.currentModelCode || '023-the-bomblet',
            currentModelId: data.currentModelId || null,
            modelSeries: currentModel.MODEL_SERIES || (data.currentModelCode?.includes('017') ? '017' : '023'),
            basePrice: currentModel.BASE_PRICE || 0,
            
            // Section states
            spheres: { variant: 'standard', color: null, colorValue: null, name: 'Стандартный' },
            body: { variant: 'standard', color: null, colorValue: null, name: 'Стандартный' },
            logo: { variant: 'standard', customLogo: null, name: 'Стандартный' },
            logobg: { color: 'standard', colorValue: null, name: 'Стандартный' },
            case: { 
                variant: 'standard', 
                customLogo: null, 
                laserEngravingEnabled: false,
                logoWidthMM: 100, 
                logoOffsetMM: { top: 0, left: 0 } 
            },
            shockmount: { 
                enabled: false, 
                variant: 'standard', 
