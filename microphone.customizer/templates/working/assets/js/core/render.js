...
import { updateShockmountVisibility, updateShockmountLayers, updateShockmountPreview, updateShockmountPinsPreview } from '../modules/shockmount.js';
import { calculateTotal, getBreakdown } from '../utils/PriceCalculator.js';
...
export function render() {
    console.log("[Render] Re-rendering UI from state.");
