...
class StateManager {
    ...
    constructor() {
        this.#state = {
            ...
            spheres: { variant: '3', color: null, colorValue: '#7d7d7dff' },
            body: { variant: '3', color: null, colorValue: '#a1a1a0' },
            logo: { variant: 'silver', colorValue: '#A1A1A0', customLogo: null },
            ...
            shockmount: { enabled: true, variant: 'shock-RAL9005', color: null, colorValue: '#ffffff' },
            shockmountPins: { variant: 'pins-RAL9005', colorValue: '#F4F4F4', material: null },
