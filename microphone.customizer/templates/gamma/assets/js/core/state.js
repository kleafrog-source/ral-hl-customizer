...
class StateManager {
    ...
    constructor() {
        this.#state = {
            ...
            spheres: { variant: 'spheres-satinsteel', color: null, colorValue: '#7d7d7dff' },
            body: { variant: 'body-satinsteel', color: null, colorValue: '#a1a1a0' },
            logo: { variant: 'coldchrome', colorValue: '#A1A1A0', customLogo: null },
            logobg: { color: '3001', colorValue: '#bb0404' },
            case: { variant: 'standard', customLogo: null, logoTransform: { x: 40, y: 26, scale: 1.2 }, logoWidthMM: 0, logoOffsetMM: { top: 0, left: 0 } },
            shockmount: { enabled: false, variant: '9005', color: null, colorValue: '#ffffff' },
            shockmountPins: { variant: 'pins-brass-023', colorValue: '#F4F4F4', material: null },
            prices: { base: CONFIG.basePrice, spheres: 0, body: 0, logo: 0, logobg: 0, case: 0, shockmount: 0 },
            initialConfig: null,
            hasChanged: false,
            savedMicConfigs: {}
        };
