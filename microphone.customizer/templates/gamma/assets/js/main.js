// ============================================
// MAIN ENTRY POINT (Gamma Template - Full HL Integration)
// ============================================

import { initEventListeners } from './ui-core.js';
import { initPalettes, initPaletteWrappers, handleStyleSelection, handleColorSelection } from './modules/appearance-new.js';
import { init as initLogo } from './modules/logo.js';
import { initCaseAndShockmount } from './modules/accessories.js';
import { initShockmount, handleShockmountVariantSelection, handleShockmountColorSelection, handleShockmountPinSelection } from './modules/shockmount-new.js';
...
import { initDataAttributesHandlers } from './modules/data-attributes-handler.js';
import './debugger.js';

// Removed old imports that are no longer needed:
// import { initColorManager, initAllQuickSelects } from './modules/color-manager.js';
// import { analyzeRalCodes, validateCurrentPricing } from './modules/ral-debug.js';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    console.log('[Main] Initializing data attributes handlers...');
    initDataAttributesHandlers();
